...
def Aplicar_FFT(Columna):
    ...
    Output: numpy array con el espectro de potencias de una señal.
    """
    return Potencias
def PLOT(Espectro):
    ...
    Input: Espectro. Vector que contiene el espectro de potencia de una señal.
    """
...
def Aplicar_InvFFT(Espectro_Limpio):
    PLOT(Espectro)
        ...
        """
        Aplica la transformada invrsa de FOurier a un vector de puntos y grafica la señal filtrada.
        Input: Espectro_Limpio.Vector que contiene los 10 valores mas grandes del espectro de potencias de cada señal.
        Output: Señal filtrada. Vector que contiene los datos de una señal mas limpia.Grafica de dicha señal.
        """
