...
float* RungeKuttaFourthOrderStep(float h, float t_old, float x_old, float y_old, float vx_old, float vy_old, float x_cm, float y_cm){
  ...
  /**
  -----------------------------------------
  CUANDO HAY DOS GALAXIAS
  -----------------------------------------
  **/

  float func_x_prime_2(float t, float x, float y, float vx, float vy, float x_cm, float y_cm, float x_cm_2, float y_cm_2){
  return vx;
}

  float func_y_prime_2(float t, float x, float y, float vx, float vy, float x_cm, float y_cm, float x_cm_2, float y_cm_2){
  return vy;
}

  float func_vx_prime_2(float t, float x, float y, float vx, float vy, float x_cm, float y_cm, float x_cm_2, float y_cm_2){
  return (-C_GRAV*M_CENT*abs(x-x_cm))/(pow(((x-x_cm)*(x-x_cm)+(y-y_cm)*(y-y_cm)),(3.0/2.0))) + (-C_GRAV*M_CENT*abs(x-x_cm_2))/(pow(((x-x_cm_2)*(x-x_cm_2)+(y-y_cm_2)*(y-y_cm_2)),(3.0/2.0))); 
}

  float func_vy_prime_2(float t, float x, float y, float vx, float vy, float x_cm, float y_cm, float x_cm_2, float y_cm_2){
    return (-C_GRAV*M_CENT*abs(y-y_cm))/(pow(((x-x_cm)*(x-x_cm)+(y-y_cm)*(y-y_cm)),(3.0/2.0))) + (-C_GRAV*M_CENT*abs(y-y_cm_2))/(pow(((x-x_cm_2)*(x-x_cm_2)+(y-y_cm_2)*(y-y_cm_2)),(3.0/2.0))); 
}

  float* RungeKuttaFourthOrderStep_2(float h, float t_old, float x_old, float y_old, float vx_old, float vy_old, float x_cm, float y_cm, float x_cm_2, float y_cm_2){
  ...
  k1_x = func_x_prime_2(t_old, x_old, y_old, vx_old, vy_old, x_cm, y_cm, x_cm_2, y_cm_2);
  k1_y = func_y_prime_2(t_old, x_old, y_old, vx_old, vy_old, x_cm, y_cm, x_cm_2, y_cm_2);
  k1_vx = func_vx_prime_2(t_old, x_old, y_old, vx_old, vy_old, x_cm, y_cm, x_cm_2, y_cm_2);
  k1_vy = func_vy_prime_2(t_old, x_old, y_old, vx_old, vy_old, x_cm, y_cm, x_cm_2, y_cm_2);
  ...
  k2_x = func_x_prime_2(t_middle_1, x_middle_1, y_middle_1, vx_middle_1, vy_middle_1, x_cm, y_cm, x_cm_2, y_cm_2);
  k2_y = func_y_prime_2(t_middle_1, x_middle_1, y_middle_1, vx_middle_1, vy_middle_1, x_cm, y_cm, x_cm_2, y_cm_2);
  k2_vx = func_vx_prime_2(t_middle_1, x_middle_1, y_middle_1, vx_middle_1, vy_middle_1, x_cm, y_cm, x_cm_2, y_cm_2);
  k2_vy = func_vy_prime_2(t_middle_1, x_middle_1, y_middle_1, vx_middle_1, vy_middle_1, x_cm, y_cm, x_cm_2, y_cm_2);
  ...
  k3_x = func_x_prime_2(t_middle_2, x_middle_2, y_middle_2, vx_middle_2, vy_middle_2, x_cm, y_cm, x_cm_2, y_cm_2);
  k3_y = func_y_prime_2(t_middle_2, x_middle_2, y_middle_2, vx_middle_2, vy_middle_2, x_cm, y_cm, x_cm_2, y_cm_2);
  k3_vx = func_vx_prime_2(t_middle_2, x_middle_2, y_middle_2, vx_middle_2, vy_middle_2, x_cm, y_cm, x_cm_2, y_cm_2);
  k3_vy = func_vy_prime_2(t_middle_2, x_middle_2, y_middle_2, vx_middle_2, vy_middle_2, x_cm, y_cm, x_cm_2, y_cm_2);
  ...
  float k4_x = func_x_prime_2(t_end, x_end, y_end, vx_end, vy_end, x_cm, y_cm, x_cm_2, y_cm_2);
  float k4_y = func_y_prime_2(t_end, x_end, y_end, vx_end, vy_end, x_cm, y_cm, x_cm_2, y_cm_2);
  float k4_vx = func_vx_prime_2(t_end, x_end, y_end, vx_end, vy_end, x_cm, y_cm, x_cm_2, y_cm_2);
  float k4_vy = func_vy_prime_2(t_end, x_end, y_end, vx_end, vy_end, x_cm, y_cm, x_cm_2, y_cm_2);
